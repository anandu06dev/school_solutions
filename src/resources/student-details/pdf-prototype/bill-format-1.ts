export const studentdetailBill = {
    header: {
        columns: [
            { text: 'Anand LEFT', style: 'documentHeaderLeft' },
            { text: 'Anand CENTER', style: 'documentHeaderCenter' },
            { text: 'Anand RIGHT', style: 'documentHeaderRight' },
        ],
    },
    footer: {
        columns: [
            ...
            {
                text: 'Copyright © 2022 SA Inc. All rights reserved.',
